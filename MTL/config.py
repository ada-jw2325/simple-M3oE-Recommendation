...
# --- 模型超参数 ---
EMBEDDING_DIM = 32
HIDDEN_UNITS = {"bottom":[512, 256, 128], 'tower':[64, 16, 4]}
...
SPARSE_FEATURES = ['user_id', 'video_id', 'author_id', 'music_id', 'is_profile_enter', 'user_active_degree', 'is_live_streamer', 'is_video_author', 'is_lowactive_period', 'follow_user_num_range', 'fans_user_num_range', 'friend_user_num_range', 'register_days_range', 'video_type', 'upload_type', 'visible_status', 'music_type', 'tab', 'onehot_feat0', 'onehot_feat1', 'onehot_feat2', 'onehot_feat3', 'onehot_feat4', 'onehot_feat5', 'onehot_feat6', 'onehot_feat7', 'onehot_feat8', 'onehot_feat9', 'onehot_feat10', 'onehot_feat11', 'onehot_feat12', 'onehot_feat13', 'onehot_feat14', 'onehot_feat15', 'onehot_feat16', 'onehot_feat17']
