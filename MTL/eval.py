...
from model import SharedBottom
...
def main():
	...
	model_path = os.path.join(SAVED_MODEL_PATH, "shared_bottom_best_model.pth")
	...
	txt_path = os.path.join(ROOT_PATH, "mtl_evaluation_results.txt")
	json_path = os.path.join(ROOT_PATH, "mtl_evaluation_results.json")
	...
	with open(json_path, "w", encoding="utf-8") as f:
		json.dump({"model": "MTL", "results": results}, f, indent=2, ensure_ascii=False)
