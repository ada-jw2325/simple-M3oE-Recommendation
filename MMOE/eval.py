...
def main():
    ...
    model_path = os.path.join(SAVED_MODEL_PATH, "mmoe_best_model.pth")
    ...
    txt_path = os.path.join(ROOT_PATH, "mmoe_evaluation_results.txt")
    json_path = os.path.join(ROOT_PATH, "mmoe_evaluation_results.json")
    ...
    with open(json_path, "w", encoding="utf-8") as f:
        json.dump({"model": "MMOE", "results": results}, f, indent=2, ensure_ascii=False)
