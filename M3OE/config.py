...
FEATURE_INFO_PATH = os.path.join(DATA_PATH, 'processedM3OE/feature_max_idx_withoutTag.json')
ONLINE_TEST_PKL_PATH = DATA_PATH + 'processedM3OE/online_test_data.pkl'
RANDOM_TEST_PKL_PATH = DATA_PATH + 'processedM3OE/random_test_data.pkl'

TRAIN_PKL_PATH = DATA_PATH + 'processedM3OE/train_data.pkl'
TEST_PKL_PATH = DATA_PATH + 'processedM3OE/test_data.pkl'


# --- 输出路径 ---
PROCESSED_DATA_PATH = DATA_PATH + "processedM3OE/"
...
HIDDEN_UNITS = {'expert':[32], 'tower':[16]}
